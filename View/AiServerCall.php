...
function extractPercentage($inputString) {
    // Regular expression pattern to match a percentage value
    $pattern = '/\b\d+(?:\.\d+)?(?=%)/';

    // Perform the regular expression match
    preg_match($pattern, $inputString, $matches);

    // If a match is found, return the first percentage value
    if (!empty($matches)) {
        return $matches[0] . '%'; // Append '%' to the matched value
    } else {
        return null; // Return null if no percentage value is found
    }
}

    $url = "https://right-sparrow-shining.ngrok-free.app/api/generate";
    ...
    $data = array(
        "model" => "mistral",
        "prompt" => "Job Description: We are hiring a graphic designer to join 
        our creative team. The ideal candidate should have proficiency 
        in Adobe Creative Suite, particularly Photoshop, Illustrator, 
        and InDesign. Strong design skills, creativity, and attention 
        to detail are essential.
        Experience in both print and digital design is preferred. 
        The designer will collaborate with the marketing team to create
        visually appealing graphics for various marketing materials, 
        including social media posts, advertisements, and website
        content.
        ...
        Once you've provided the necessary details, ask the 
        AI assistant whether the job fits your skills.
        The AI will analyze the information and offer a 
        recommendation based on the analysis. give your percentage of confidance at the end.",
        "stream" => false
    );
                ...
                <tr>
                    <td>
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">AI Final Assessment</h5>
                                <p class="card-text">' . $resultText . '</p>
                                <a href="AiServerCall.php" class="btn btn-success">Regenerate response</a>
                            </div>
        ...
        <script>
            document.addEventListener(\'DOMContentLoaded\', function() {
                ...
                if (ctx) {
                    ...
                    var acceptance =89; // Example acceptance percentage
                    var rejection = 11; // Example rejection percentage
