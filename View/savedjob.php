...
<a href="appliedjobs.php">
  ...
  <button type="submit"id=boutton style="float:right">Applied jobs</button>
</a>
<br><br><br>
<div >
...
$jobList = $jobClass->getApplicationsByUserAndType($_SESSION['id'],1);

if(empty($jobList)) {
  echo('<div class="alert alert-info" role="alert">
  No job saved yet, why not check <a href="http://localhost/integration_finale/View/frontjob.php">them out?</a> 
</div>');
}
  ...
  <div class="col-md-6 d-flex align-items-center justify-between">
    ...
    <div class="p-2">
      <div class="CardFooter">
        <button class="Button outline" onclick="window.location.href='http://localhost/integration_finale/View/SaveApplyJobV2.php?job=<?php echo $job["id"]; ?>&type=0';">Apply</button>
      </div>
    </div>
  </div>
</div>
